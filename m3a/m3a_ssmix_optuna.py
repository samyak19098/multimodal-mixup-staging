...
def objective(trial):
	...
	params = {
		...
		"learning_rate": trial.suggest_loguniform("lr", 8e-4, 2e-3),
		"loss_original_coef": trial.suggest_loguniform("loss_original_coef", 0.1, 0),
		"loss_intra_coef": trial.suggest_loguniform("loss_intra_coef", 0.1, 0),
